...
RUN apt-get update && apt-get install -y unzip build-essential wget virtualenv libspatialindex-dev python-rtree git osmium-tool htop jq parallel && apt -t stretch-backports install osmium-tool
